...
var _crudR = {
    ...
    */
    ...
    dtCheckStatusName: function (value) {
        return (value == '0') ? '<span>' + _BR.CheckStatusNull + '</span>' :
            (value == 'Y') ? '<span>' + _BR.CheckStatusYes + '</span>' :
            '<span class="text-danger">' + _BR.CheckStatusNo + '</span>';
    },
