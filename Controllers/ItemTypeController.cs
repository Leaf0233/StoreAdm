...
{
    //[XgProgAuth]
    public class ItemTypeController : BaseCtrl
    {
        ...
        {
            return JsonToCnt(await new ItemTypeRead().GetPageA(Ctrl, dt));
        }

        private ItemTypeEdit EditService()
        {
            return new ItemTypeEdit(Ctrl);
        }
