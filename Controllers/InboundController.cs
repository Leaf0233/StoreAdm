...
namespace StoreAdm.Controllers
{
    ...
    public class InboundController : BaseCtrl
    {
        ...
        public async Task<ContentResult> GetPage(DtDto dt)
             {
            return JsonToCnt(await new InboundRead().GetPageA(Ctrl, dt));
        }

        private InboundEdit EditService()
        {
            return new InboundEdit(Ctrl);
        }
