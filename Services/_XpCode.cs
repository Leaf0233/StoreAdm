...
namespace StoreAdm.Services
{
    ...
    public static class _XpCode
    {
        ...
        {
            return await _Db.TableToCodesA("ItemType", db);
        }
        public static async Task<List<IdStrDto>> MakersA(Db db = null)
        {
            return await _Db.TableToCodesA("Maker", db);
        }
        public static async Task<List<IdStrDto>> CheckStatusA(Db db = null)
        {
            return await _Db.TableToCodesA("CheckStatus", db);
        }
        public static async Task<List<IdStrDto>> ItemsA(Db db = null)
        {
            return await _Db.TableToCodesA("Item", db);
        }
...
order by Sort";
        ...
        */
        ...
        public static async Task<List<IdStrDto>> GetCheckStatusesA(Db? db = null)
        {
            return await _Db.TypeToCodesA("CheckStatus", db, _Xp.GetLocale0());
        }
        public static async Task<List<IdStrDto>> GetStatusesA(Db? db = null)
        {
            return await _Db.TypeToCodesA("Status", db, _Xp.GetLocale0());
        }
...
order by Sort";
        ...
        */
        ...
        public static async Task<List<IdStrExtDto>> ItemExtsA(Db db = null)
        {
            var emptyDb = (db == null);
            if (emptyDb)
                db = new Db();
